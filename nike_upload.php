...
if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($image_tmp_name, $image_folder)) { 
        ...
        $sql = "INSERT INTO nike (title, price, size_range, color, description, img_path) 
...
<nav>
    ...
    <br>
    <h3>Upload Your Nike Stock Only ! </h3>
    ...
    <form action="nike_upload.php" method="POST" enctype="multipart/form-data">
